...
namespace GameLib
{
    ...
    PadAssign keyAssign00[] = {
        ...
        { PAD_TRG1      , Keyboard::X },            // 'Z'
        { PAD_TRG2      , Keyboard::Z },            // 'X'
       // { PAD_TRG3      , Keyboard::C },            // 'C'
        ...
        { PAD_SPACE     , Keyboard::Space },          // 'M'

        //{ PAD_START    , VK_LBUTTON },              // マウス左ボタン
        { PAD_TRG4     , Keyboard::Up },              // マウス右ボタン
    ...
    PadAssign joyAssign00[] = {
        { PAD_UP        , GamePad::A },            // 上キー
        { PAD_DOWN      , GamePad::DOWN },          // 下キー
        { PAD_LEFT    	, GamePad::LEFT },          // 左キー
        { PAD_RIGHT     , GamePad::RIGHT },         // 右キー

        { PAD_START     , GamePad::B },         // スタートボタン
        { PAD_TRG1      , GamePad::UP},             // Aボタン
        { PAD_TRG2      , GamePad::Y },             // Bボタン
        { PAD_TRG3      , GamePad::BACK },             // Xボタン
        { PAD_TRG4      , GamePad::UP },             // Yボタン
        { PAD_L1        , GamePad::LSHOULDER },     // Lボタン
        { PAD_SPACE     , GamePad::RSHOULDER },     // Rボタン
        { PAD_L3        , GamePad::LSTICK },        // Lスティック
        { PAD_R3        , GamePad::RSTICK },        // Rスティック

        { PAD_SELECT    , GamePad::START },          // バック（セレクト）ボタン
